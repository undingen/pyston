...
#define _PyObject_GC_TRACK(o) do { \
    PyGC_Head *g = _Py_AS_GC(o), *PyGC_generation0 = _PyGC_generation0, *prev = PyGC_generation0->gc.gc_prev; \
    if (__builtin_expect(g->gc.gc_refs != _PyGC_REFS_UNTRACKED, 0)) \
        Py_FatalError("GC object already tracked"); \
    PyGC_generation0->gc.gc_prev = g; \
    g->gc.gc_refs = _PyGC_REFS_REACHABLE; \
    g->gc.gc_next = PyGC_generation0; \
    g->gc.gc_prev = prev; \
    prev->gc.gc_next = g; \
    } while (0);
