        ...
        if (Py_TYPE(descr) == &PyWrapperDescr_Type
            ...
            /* XXX I'm not 100% sure that there isn't a hole
               ...
               point out a bug in this reasoning a beer. */
                   ...
                   && !static_cast<BoxedFunction*>(descr)->md->accepts_all_input_version.empty()) {
            auto md = static_cast<BoxedFunction*>(descr)->md;
            if (md->accepts_all_input_version.get<CAPI>())
                specific = md->accepts_all_input_version.get<CAPI>();
            else {
                type->tpp_descr_get = (descrgetfunc)md->accepts_all_input_version.get<CXX>()->code;
