...
ICSetupInfo* createCallsiteIC(TypeRecorder* type_recorder, int num_args, ICInfo* bjit_ic_info) {
    return ICSetupInfo::initialize(true, numSlots(bjit_ic_info, 4), (640 + 48 * num_args) / 2, ICSetupInfo::Callsite,
                                   type_recorder);
}
...
ICSetupInfo* createBinexpIC(TypeRecorder* type_recorder, ICInfo* bjit_ic_info) {
    return ICSetupInfo::initialize(true, numSlots(bjit_ic_info, 4), 512 / 2, ICSetupInfo::Binexp, type_recorder);
}
