...
// It can contains a variable number blocks generated by JitFragment instances.
// A JitFragment always contains the code of a single CFGBlock*.
//
...
//                                  ; eax contains the next block to execute
