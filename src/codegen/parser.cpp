...
AST_alias* read_alias(BufferedReader* reader) {
    ...
    AST_alias* rtn = new (*reader->ast_allocator) AST_alias(name, asname);
    rtn->col_offset = -1;
    rtn->lineno = -1;
...
AST_arguments* read_arguments(BufferedReader* reader) {
    ...
    AST_arguments* rtn = new (*reader->ast_allocator) AST_arguments();
...
AST_Assert* read_assert(BufferedReader* reader) {
    AST_Assert* rtn = new (*reader->ast_allocator) AST_Assert();
...
AST_Assign* read_assign(BufferedReader* reader) {
    AST_Assign* rtn = new (*reader->ast_allocator) AST_Assign();
...
AST_AugAssign* read_augassign(BufferedReader* reader) {
    AST_AugAssign* rtn = new (*reader->ast_allocator) AST_AugAssign();
...
AST_Attribute* read_attribute(BufferedReader* reader) {
    AST_Attribute* rtn = new (*reader->ast_allocator) AST_Attribute();
...
AST_expr* read_binop(BufferedReader* reader) {
    AST_BinOp* rtn = new (*reader->ast_allocator) AST_BinOp();
...
AST_expr* read_boolop(BufferedReader* reader) {
    AST_BoolOp* rtn = new (*reader->ast_allocator) AST_BoolOp();
...
AST_Break* read_break(BufferedReader* reader) {
    AST_Break* rtn = new (*reader->ast_allocator) AST_Break();
...
AST_Call* read_call(BufferedReader* reader) {
    AST_Call* rtn = new (*reader->ast_allocator) AST_Call();
...
AST_expr* read_compare(BufferedReader* reader) {
    AST_Compare* rtn = new (*reader->ast_allocator) AST_Compare();
...
AST_comprehension* read_comprehension(BufferedReader* reader) {
    AST_comprehension* rtn = new (*reader->ast_allocator) AST_comprehension();
...
AST_ClassDef* read_classdef(BufferedReader* reader) {
    AST_ClassDef* rtn = new (*reader->ast_allocator) AST_ClassDef();
...
AST_Continue* read_continue(BufferedReader* reader) {
    AST_Continue* rtn = new (*reader->ast_allocator) AST_Continue();
...
AST_Delete* read_delete(BufferedReader* reader) {
    AST_Delete* rtn = new (*reader->ast_allocator) AST_Delete();
...
AST_Dict* read_dict(BufferedReader* reader) {
    AST_Dict* rtn = new (*reader->ast_allocator) AST_Dict();
...
AST_DictComp* read_dictcomp(BufferedReader* reader) {
    AST_DictComp* rtn = new (*reader->ast_allocator) AST_DictComp();
    rtn->col_offset = readColOffset(reader);
...
AST_Ellipsis* read_ellipsis(BufferedReader* reader) {
    AST_Ellipsis* rtn = new (*reader->ast_allocator) AST_Ellipsis();
    rtn->col_offset = -1;
    rtn->lineno = -1;
    return rtn;
}
...
AST_ExceptHandler* read_excepthandler(BufferedReader* reader) {
    AST_ExceptHandler* rtn = new (*reader->ast_allocator) AST_ExceptHandler();
...
AST_Exec* read_exec(BufferedReader* reader) {
    AST_Exec* rtn = new (*reader->ast_allocator) AST_Exec();
...
AST_Expr* read_expr(BufferedReader* reader) {
    AST_Expr* rtn = new (*reader->ast_allocator) AST_Expr();
...
AST_ExtSlice* read_extslice(BufferedReader* reader) {
    AST_ExtSlice* rtn = new (*reader->ast_allocator) AST_ExtSlice();
...
AST_For* read_for(BufferedReader* reader) {
    AST_For* rtn = new (*reader->ast_allocator) AST_For();
...
AST_FunctionDef* read_functiondef(BufferedReader* reader) {
    ...
    AST_FunctionDef* rtn = new (*reader->ast_allocator) AST_FunctionDef();
...
AST_GeneratorExp* read_generatorexp(BufferedReader* reader) {
    AST_GeneratorExp* rtn = new (*reader->ast_allocator) AST_GeneratorExp();
...
AST_Global* read_global(BufferedReader* reader) {
    AST_Global* rtn = new (*reader->ast_allocator) AST_Global();
...
AST_If* read_if(BufferedReader* reader) {
    AST_If* rtn = new (*reader->ast_allocator) AST_If();
...
AST_IfExp* read_ifexp(BufferedReader* reader) {
    AST_IfExp* rtn = new (*reader->ast_allocator) AST_IfExp();
...
AST_Import* read_import(BufferedReader* reader) {
    AST_Import* rtn = new (*reader->ast_allocator) AST_Import();
...
AST_ImportFrom* read_importfrom(BufferedReader* reader) {
    AST_ImportFrom* rtn = new (*reader->ast_allocator) AST_ImportFrom();
...
AST_Index* read_index(BufferedReader* reader) {
    AST_Index* rtn = new (*reader->ast_allocator) AST_Index();
...
AST_keyword* read_keyword(BufferedReader* reader) {
    AST_keyword* rtn = new (*reader->ast_allocator) AST_keyword();
...
AST_Lambda* read_lambda(BufferedReader* reader) {
    AST_Lambda* rtn = new (*reader->ast_allocator) AST_Lambda();
...
AST_List* read_list(BufferedReader* reader) {
    AST_List* rtn = new (*reader->ast_allocator) AST_List();
...
AST_ListComp* read_listcomp(BufferedReader* reader) {
    AST_ListComp* rtn = new (*reader->ast_allocator) AST_ListComp();
...
AST_Module* read_module(BufferedReader* reader) {
    ...
    AST_Module* rtn = new (*reader->ast_allocator) AST_Module(reader->createInternedPool());
...
AST_Name* read_name(BufferedReader* reader) {
    ...
    return new (*reader->ast_allocator) AST_Name(std::move(id), ctx_type, lineno, col_offset);
}

AST_Num* read_num(BufferedReader* reader) {
    AST_Num* rtn = new (*reader->ast_allocator) AST_Num();
...
AST_Repr* read_repr(BufferedReader* reader) {
    AST_Repr* rtn = new (*reader->ast_allocator) AST_Repr();
    rtn->col_offset = readColOffset(reader);
    rtn->lineno = reader->readULL();
    rtn->value = readASTExpr(reader);
...
AST_Pass* read_pass(BufferedReader* reader) {
    AST_Pass* rtn = new (*reader->ast_allocator) AST_Pass();
...
AST_Print* read_print(BufferedReader* reader) {
    AST_Print* rtn = new (*reader->ast_allocator) AST_Print();
...
AST_Raise* read_raise(BufferedReader* reader) {
    AST_Raise* rtn = new (*reader->ast_allocator) AST_Raise();
...
AST_Return* read_return(BufferedReader* reader) {
    AST_Return* rtn = new (*reader->ast_allocator) AST_Return();
...
AST_Set* read_set(BufferedReader* reader) {
    AST_Set* rtn = new (*reader->ast_allocator) AST_Set();
...
AST_SetComp* read_setcomp(BufferedReader* reader) {
    AST_SetComp* rtn = new (*reader->ast_allocator) AST_SetComp();
...
AST_Slice* read_slice(BufferedReader* reader) {
    AST_Slice* rtn = new (*reader->ast_allocator) AST_Slice();
...
AST_Str* read_str(BufferedReader* reader) {
    AST_Str* rtn = new (*reader->ast_allocator) AST_Str();
...
AST_Subscript* read_subscript(BufferedReader* reader) {
    AST_Subscript* rtn = new (*reader->ast_allocator) AST_Subscript();
...
AST_TryExcept* read_tryexcept(BufferedReader* reader) {
    AST_TryExcept* rtn = new (*reader->ast_allocator) AST_TryExcept();
...
AST_TryFinally* read_tryfinally(BufferedReader* reader) {
    AST_TryFinally* rtn = new (*reader->ast_allocator) AST_TryFinally();
...
AST_Tuple* read_tuple(BufferedReader* reader) {
    AST_Tuple* rtn = new (*reader->ast_allocator) AST_Tuple();
...
AST_UnaryOp* read_unaryop(BufferedReader* reader) {
    AST_UnaryOp* rtn = new (*reader->ast_allocator) AST_UnaryOp();
...
AST_While* read_while(BufferedReader* reader) {
    AST_While* rtn = new (*reader->ast_allocator) AST_While();
...
AST_With* read_with(BufferedReader* reader) {
    AST_With* rtn = new (*reader->ast_allocator) AST_With();
...
AST_Yield* read_yield(BufferedReader* reader) {
    AST_Yield* rtn = new (*reader->ast_allocator) AST_Yield();
