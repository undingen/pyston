...
// this->_call(NULL, true, false /* can't throw */, (void*)Helper::decref, llvm::ArrayRef<RewriterVar*>(&var, 1),
...
void Rewriter::_xdecref(RewriterVar* var) {
    ...
    this->_call(NULL, true, false /* can't throw */, (void*)Helper::xdecref, llvm::ArrayRef<RewriterVar*>(&var, 1),
...
void RewriterVar::refConsumed(RewriterAction* action) {
    ...
    action->consumed_refs.push_back(this);
}
