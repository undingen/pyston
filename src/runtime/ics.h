...
public:
    CallattrIC() : RuntimeIC((void*)callattr, 1, 160 * 5) {}

    Box* call(Box* obj, BoxedString* attr, CallattrFlags flags, ArgPassSpec spec, Box* arg0, Box* arg1) {
        return (Box*)call_ptr(obj, attr, flags, spec, arg0, arg1);
    }
};
