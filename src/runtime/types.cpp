...
Box* instancemethodGet(BoxedInstanceMethod* self, Box* obj, Box* type) {
    RELEASE_ASSERT(self->cls == &PyMethod_Type, "");
    ...
    return boxInstanceMethod(obj, self->func, self->im_class);
}
...
void setupRuntime() {
    ...
    /*
        instancemethod_cls->giveAttr("__new__", new BoxedFunction(BoxedCode::create((void*)instancemethodNew, UNKNOWN,
       4,
                                                                                    false, false,
       "instancemethod.__new__"),
                                                                  { NULL }));
        instancemethod_cls->giveAttr(
            "__repr__", new BoxedFunction(BoxedCode::create((void*)instancemethodRepr, STR, 1,
       "instancemethod.__repr__")));
        instancemethod_cls->giveAttr("__hash__", new BoxedFunction(BoxedCode::create((void*)instancemethodHash, UNKNOWN,
       1,
                                                                                     "instancemethod.__hash__")));
        instancemethod_cls->giveAttr("__get__",
                                     new BoxedFunction(BoxedCode::create((void*)instancemethodGet, UNKNOWN, 3, false,
       false,
        ...
        instancemethod_cls->giveAttr("__call__", new BoxedFunction(BoxedCode::create(
                                                     ...
                                                     "instancemethod.__call__", "", ParamNames({ "self" }, "args",
       "kw"))));
