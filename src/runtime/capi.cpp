...
extern "C" PyObject* PyObject_Call(PyObject* func, PyObject* arg, PyObject* kw) noexcept {
    ternaryfunc call;

    if ((call = func->cls->tp_call) != NULL) {
        PyObject* result;
    ...
    PyErr_Format(PyExc_TypeError, "'%.200s' object is not callable", func->cls->tp_name);
    return NULL;
}
